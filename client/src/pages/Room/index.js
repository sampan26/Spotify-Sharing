...
const Room = () => {
  ...
  const handleUser = null;

  const handleStatusMsg = null;

  const handleSockets = null;


  const handleCurrentRoomTrack =  null;
  const handleCurrentlyPlaying = null;

  const renderAvatarSlides = null;

  const updateTrackInDB = null;
